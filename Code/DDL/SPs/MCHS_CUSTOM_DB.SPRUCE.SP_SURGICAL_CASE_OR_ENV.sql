-- MCHS_CUSTOM_DB.SPRUCE.SP_SURGICAL_CASE_OR_ENV.sql
...
CREATE OR REPLACE PROCEDURE MCHS_CUSTOM_DB.SPRUCE.SP_SURGICAL_CASE_OR_ENV()
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS 
$$
var sql_tmp = `CREATE OR REPLACE TEMPORARY TABLE MCHS_CUSTOM_DB.SPRUCE.TEMP_SURGICAL_CASE_OR_ADMIN_MEDS AS (
...
CALL MCHS_CUSTOM_DB.SPRUCE.SP_SURGICAL_CASE_OR_ENV();
-- Successful 2025.02.10
-- Number of records affected: 171,526
 
SELECT COUNT(*) AS COUNT
FROM MCHS_CUSTOM_DB.SPRUCE.SURGICAL_CASE_OR_ENV  -- 721334, mostly loaded manually previously 
