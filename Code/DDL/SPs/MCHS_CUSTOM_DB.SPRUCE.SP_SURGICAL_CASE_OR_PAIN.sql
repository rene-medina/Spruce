-- MCHS_CUSTOM_DB.SPRUCE.SP_SURGICAL_CASE_OR_PAIN.sql
...
--TRUNCATE TABLE MCHS_CUSTOM_DB.SPRUCE.SURGICAL_CASE_OR_PAIN;

CREATE OR REPLACE PROCEDURE MCHS_CUSTOM_DB.SPRUCE.SP_SURGICAL_CASE_OR_PAIN()
RETURNS VARCHAR(16777216)
LANGUAGE JAVASCRIPT
EXECUTE AS OWNER
AS 
$$
var sql_tmp = `CREATE OR REPLACE TEMPORARY TABLE MCHS_CUSTOM_DB.SPRUCE.TEMP_SURGICAL_CASE_OR_PAIN AS (
...
CALL MCHS_CUSTOM_DB.SPRUCE.SP_SURGICAL_CASE_OR_PAIN();
-- Successful 2025.02.10
-- Number of records affected: 167,867
 
SELECT COUNT(*) AS COUNT
FROM MCHS_CUSTOM_DB.SPRUCE.SURGICAL_CASE_OR_PAIN  -- 3,251,350, mostly loaded manually previously 
