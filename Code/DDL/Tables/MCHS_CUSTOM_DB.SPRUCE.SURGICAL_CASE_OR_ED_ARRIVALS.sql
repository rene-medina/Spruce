-- MCHS_CUSTOM_DB.SPRUCE.SURGICAL_CASE_OR_ED_ARRIVALS.sql
...
--DROP TABLE MCHS_CUSTOM_DB.SPRUCE.SURGICAL_CASE_OR_ED_ARRIVALS;
CREATE TABLE MCHS_CUSTOM_DB.SPRUCE.SURGICAL_CASE_OR_ED_ARRIVALS (       
   ...
   ED_ENCOUNTER_IDENTIFIER                  VARCHAR(400)      COMMENT 'Unique encounter identifier for the ED arrival.',
   ED_ARRIVAL_TS                            TIMESTAMP_LTZ(9)  COMMENT 'Date and time the patient arrived in the Emergency Department. (Use YYYY-MM-DD HH:MM:SS format.)',
