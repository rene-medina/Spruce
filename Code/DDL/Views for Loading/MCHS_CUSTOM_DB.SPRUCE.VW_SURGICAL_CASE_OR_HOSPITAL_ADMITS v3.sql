-- MCHS_CUSTOM_DB.SPRUCE.VW_SURGICAL_CASE_OR_HOSPITAL_ADMITS v3.sql
...
--FROM MCHS_CUSTOM_DB.SPRUCE.VW_SURGICAL_CASE_OR_HOSPITAL_ADMITS
--ORDER BY NCHS_ONLY_PERSON_ID
--        ,HOSPITAL_ADMIT_INPATIENT_TS; -- 10,429 with the 30 days cap. (Previously 19,041 on 2025.02.07)
        
--SELECT NCHS_ONLY_ENCOUNTER_ID
